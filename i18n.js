const i18n = {
  ...
  'hi': {
    ...
    settings: 'सेटिंग्स',
    minWidth: 'न्यूनतम चौड़ाई (पिक्सेल)',
    minHeight: 'न्यूनतम ऊंचाई (पिक्सेल)',
    save: 'सहेजें',
  ...
  'tr': {
    ...
    settings: 'Ayarlar',
    minWidth: 'Min. Genişlik (px)',
    minHeight: 'Min. Yükseklik (px)',
    save: 'Kaydet',
  ...
  'id': {
    ...
    settings: 'Pengaturan',
    minWidth: 'Lebar Minimum (px)',
    minHeight: 'Tinggi Minimum (px)',
    save: 'Simpan',
